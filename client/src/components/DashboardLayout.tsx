...
import { BarChart3, FileText, Key, LayoutDashboard, LogOut, MessageSquare, PanelLeft, TrendingUp, Users, School } from "lucide-react";
...
const menuItems = [
  ...
  { icon: School, label: "Scholen", path: "/scholen" },
